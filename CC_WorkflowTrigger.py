...
##just feels right to let computer catch up before continuing
time.sleep(2)
...
#STEP4
list_files = subprocess.run("python CC_CompiledDataToJSON.py",cwd=r"C:\Users\paige\OneDrive\Documents\HMS_CC_Final")
