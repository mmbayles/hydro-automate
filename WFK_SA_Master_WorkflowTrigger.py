...
for basin in range(len(subbasins_no_dams)):
    WFK_CNs = WFK.get_SA_CN(f'{subbasins_no_dams[basin]}') #this updated definition of WFK_CNs will be applied to the object by the same name in step 1
    ...
    list_files = subprocess.run("python WFK_sa_cn_adjustments.py",cwd=r"C:\Users\paige\OneDrive\Documents\HMS_WFK_Final")
    ...
    list_files = subprocess.run("python WFK_sa_CompiledDataToJSON.py",cwd=r"C:\Users\paige\OneDrive\Documents\HMS_WFK_Final")
